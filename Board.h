...
public:
	...
	//Linkedlist method requires copy constructor, assignment operator, destructor
	~Board();
	Board(const Board & b);
	Board &operator=(const Board & b); //who knows how to do this //TODO
...
private:
	...
	Node * nPot; //north pot
	Node * sPot; //south pot
	Node * getNode(Side s, int index) const;
	//private function returns desired node
